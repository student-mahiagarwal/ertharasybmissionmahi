...
export default function Register() {
    ...
    const fullText = "Booting registration module... Ready to initialize account.";
        ...
        <div className="min-h-screen flex bg-black text-emerald-300 relative overflow-hidden font-mono">
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-center px-16">
                ...
                <div className="space-y-2 text-gray-500">
                    ...
                    <p> AI identity setup</p>
                    <p> Secure environment ready</p>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Initialize new user</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submitHandler} className="space-y-4">
                            ...
                            >
                                {loading ? 'Creating...' : 'INITIALIZE USER'}
                            </button>
