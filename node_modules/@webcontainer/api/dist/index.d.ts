 ...
 */
import type { FileSystemTree, AuthAPI, Unsubscribe, PreviewMessage, PreviewScriptOptions, ExportOptions, CodeEventType, CodeEvent } from './entities.js';
import { PreviewMessageType } from './preview-message-types.js';
export declare const auth: AuthAPI;
export type { DirectoryNode, FileNode, SymlinkNode, FileSystemTree, AuthAPI, AuthInitOptions, AuthFailedError, Unsubscribe, PreviewMessage, PreviewScriptOptions, BasePreviewMessage, ConsoleErrorMessage, UncaughtExceptionMessage, UnhandledRejectionMessage, ExportOptions, CodeEventType, CodeEvent, CodeEventFile, } from './entities.js';
...
export interface BootOptions {
    ...
    workdirName?: string;
    /**
     * Whether errors occurring in preview iframes on the current page should be forwarded
...
/**
 * @param message - The message sent by a preview.
 */
export declare type PreviewMessageListener = (message: PreviewMessage) => void;
/**
...
/**
 * @param text - The file or URL.
 */
export declare type OpenListener = (text: string) => void;
/**
 * @param type - Whether a file or diff is being opened.
 * @param event - A list of specified paths.
 */
export declare type CodeListener = (type: CodeEventType, event: CodeEvent) => void;
/**
 ...
 */
export declare type FSWatchCallback = (event: 'rename' | 'change', filename: string | Uint8Array) => void;
/**
...
export interface SpawnOptions {
    /**
     * Current working directory for the process, relative to the {@link WebContainer.workdir | `workdir`} of this instance (which
     * you can change when {@link WebContainer.boot | booting `WebContainer`}).
     *
     * By default, the working directory of the spawned process is {@link WebContainer.workdir | `workdir`}.
     */
    cwd?: string;
    /**
